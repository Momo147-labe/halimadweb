...
import { M as Menu, S as ShieldCheck, U as UtensilsCrossed, a as Megaphone, B as Bike, b as ShoppingBag, c as Store, L as LogOut, W as WifiOff, X } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-DYOlPPIq.css";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b bg-background/85 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-6xl items-center justify-between px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open, onOpenChange: setOpen, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "w-[250px] sm:w-[300px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-left font-bold", children: "Menu" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col gap-4 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", onClick: () => setOpen(false), activeOptions: { exact: true }, activeProps: { className: "text-primary font-semibold" }, children: "Accueil" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/restaurants", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Restaurants" }),
            user?.role === "client" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/orders", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Mes commandes" }),
            user?.role === "restaurant" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/restaurant", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Mon resto" }),
            user?.role === "ambassadeur" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/ambassadeur", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Ambassadeur" }),
            user?.role === "livreur" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/livreur", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Livreur" }),
            user?.role === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", onClick: () => setOpen(false), activeProps: { className: "text-primary font-semibold" }, children: "Admin" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground -mt-0.5 hidden sm:block", children: "Repas livrés à Labé" })
        ] })
      ] })
    ] }),
...
const $$splitComponentImporter$9 = () => import("./orders-Uv1eSd52.mjs");
...
const $$splitComponentImporter$7 = () => import("./auth-uw1PQlUp.mjs");
...
const $$splitComponentImporter$6 = () => import("./admin-B_m5rpdi.mjs");
...
const $$splitComponentImporter$5 = () => import("./index-Bj-T614X.mjs");
...
const $$splitComponentImporter$4 = () => import("./restaurants.index-C_-dyaKR.mjs");
...
const $$splitComponentImporter$3 = () => import("./restaurants._id-COUHiQmA.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard.restaurant-Cm0nzhUc.mjs");
...
const $$splitComponentImporter$1 = () => import("./dashboard.livreur-Bq6KC1zq.mjs");
...
const $$splitComponentImporter = () => import("./dashboard.ambassadeur-DH4RZ4Tg.mjs");
